...
function chkUser(p)
{
    ...
    document.getElementById("logdUser").innerHTML=lu;

}


function accCodeComeModalIndc(pcode,pid,pSource,pSrtNonValT,inicator)
{
    //alert(inicator+" inicator")
    if (inicator=='GL')
    {
        getcodcomfmodal(pcode,pid,pSource,pSrtNonValT);
    }else if (inicator=='EXEC')
    {
        getExeccodcomfmodal(pcode,pid,pSource,pSrtNonValT);
    }
