...
function autoComWithObjectGtval(val, dispfield, dbfield, vtemplate, indicator) {
...
function autocomCodeCome(val1, getvalue2, dispfield2, dbfield3, dbfield4) {
    ...
    $(display).easyAutocomplete(options, "minLength", 1);
}